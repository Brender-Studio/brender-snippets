...
def main():
    ...
    # Local Usage:
    blend_file = "path/to/your/blend/file.blend"
    output_directory = "path/to/output/directory"
    logger.info(msg="Local variables", extra={"EFS_BLENDER_FILE_PATH": blend_file, "EFS_BLENDER_OUTPUT_FOLDER_PATH": output_directory})
